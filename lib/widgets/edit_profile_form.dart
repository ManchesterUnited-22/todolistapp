...
part 'edit_profile_form/edit_profile_form_view.dart';
...
class _EditProfileFormState extends State<EditProfileForm> {
  ...
  Future<void> _save() async {
    ...
    if (full.isNotEmpty &&
        full != (widget.initialData['fullName'] as String? ?? ''))
      updatesRegister['fullName'] = full;
    if (email.isNotEmpty &&
        email != (widget.initialData['email'] as String? ?? ''))
      updatesRegister['email'] = email;
    if (_avatarUrl != null &&
        _avatarUrl != (widget.initialData['avatarUrl'] as String?))
      updatesUser['avatarUrl'] = _avatarUrl;
    ...
    if (updatesRegister.isNotEmpty) {
      ...
      await FirebaseFirestore.instance
          .collection('register')
          .doc(uid)
          .set(updatesRegister, SetOptions(merge: true));
    }
    if (updatesUser.isNotEmpty) {
      ...
      await FirebaseFirestore.instance
          .collection('users')
          .doc(uid)
          .set(updatesUser, SetOptions(merge: true));
        ...
        children: [
          ...
          Container(
            ...
            child: avatarUrl != null && avatarUrl.isNotEmpty
                ...
                : const Icon(Icons.person_rounded, size: 48, color: _C.primary),
          ),
          ...
          Positioned(
            ...
            child: GestureDetector(
              onTap: () async {
                final newUrl =
                    await AvatarService.pickAndUploadAvatarToCloudinary(
                      context,
                    );
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            hintStyle: TextStyle(
              color: _C.outline.withValues(alpha: 0.60),
              fontSize: 15,
            ),
            filled: true,
  ...
  @override
  Widget build(BuildContext context) => buildEditProfileDialog(this, context);
}
